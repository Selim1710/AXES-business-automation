    ...
    $('#addexp').click(function(e){
        ...
        if(amount != '' ){
            if(!isNaN(amount)){
                ...
                $('#itemdata').append(`<tr><td style="width:40px; text-align:center"></td><td>${expense}</td><td class ="thisamount">${amount}</td><td>${ref}</td><td class="removedata" style="width:40px; text-align:center"><a class="empty" style="cursor: pointer;"><i class="fa fa-trash"></i></a></td></tr>`);
                $('#amount').val("");
                $('#ref').val("");
                $('#expense').val("");
