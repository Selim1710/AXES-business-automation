                ...
                <div class="modal fade" id="designationCreateModel" tabindex="-1" aria-labelledby="designationCreateModelLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="create-designation" method="POST" action="{{route('designation.store')}}" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="description" id="note" maxlength="250" rows="3" placeholder="e.g. LeaveType"></textarea>
                                                </div>
                                            </div>
                                        </div>
                ...
                @foreach($leave_types as $leave_type)
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">
                            <a class="btn btn-success" style="font-size:13px" href="{{route('designation.edit',$designation->id)}}" role="button"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
