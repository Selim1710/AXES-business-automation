                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-white">
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td style="padding-left: 715px;">Total</td>
                                            <td>
                                                <input class="form-control text-right total" type="text" id="sum_total" name="total" value="0"style="padding-left: 791px;" readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" style="padding-left: 791px;">Tax</td>
                                            <td>
                                                <input class="form-control text-right"type="text" id="tax_1" name="tax_1" value="0" readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" class="text-right" style="padding-left: 741px">
                                                Discount %
                                            </td>
                                            <td>
