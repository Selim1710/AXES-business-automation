    ...
    <div class="card" style="width: 500px">
        <div class="card-body">
            <div class="border p-3 rounded">
                ...
                <form action=" {{ route ('warranty-delivered-update',$WarrantyDeliver->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                        <label class="form-label"><b>Date</b> </label>
                        <input type="text" class="form-control" name="date" value="{{$WarrantyDeliver->date}}">
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" name="note" value="{{$WarrantyDeliver->note}}">
                    </div>
