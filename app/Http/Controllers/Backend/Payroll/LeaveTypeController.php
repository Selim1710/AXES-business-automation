...
class LeaveTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('leave_type.index')->withSuccess('LeaveType Created Successfully!');
    }
    ...
    public function update(Request $request,LeaveType $leave_type)
    {
        ...
        return redirect()->route('leave_type.index')->withSuccess('LeaveType updated Successfully!');
    }
